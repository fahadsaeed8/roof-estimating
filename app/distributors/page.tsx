          ...
          <div className="bg-[#00394F] text-white p-10 rounded-l-md shadow-md">
            ...
            <div className="mb-6">
              ...
              <p className="text-sm mt-1">
                ...
                specifically for our IT distribution partners. Increase margins
                while offering competitive rates to your clients.
              </p>
            </div>
        ...
        <div className="max-w-6xl mx-auto flex flex-col-reverse md:flex-row items-center gap-10">
          ...
          <div className="flex-1">
            ...
            <div className="mt-8 space-y-6 text-[#002f4b]">
              ...
              <div>
                <h3 className="font-bold text-lg">Targeted Product Exposure</h3>
                <p className="text-sm md:text-base">
      ...
      <section className="bg-[#f9fdf8] py-20 px-4 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="mt-6 text-slate-800 text-lg leading-relaxed">
            ...
            access to advanced technology and data-driven insights that optimize
            your operations and strengthen your market presence. Our platform
            empowers distributors to expand their reach, improve efficiency, and
