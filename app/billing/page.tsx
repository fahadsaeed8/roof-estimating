    ...
    <div className="my-10">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row gap-6">
                ...
                <tbody>
                  {items.map((row, index) => (
                    <tr key={index} className="border-b border-gray-300">
                      ...
                      <td className="px-4 py-2">x{row.qty}</td>
          ...
          <div className="w-full md:w-[300px] sticky top-10 max-h-[80vh] overflow-y-auto">
            <div className="space-y-4">
              ...
              <button className="bg-red-600 text-white font-bold py-3 px-6 rounded-full w-full">
                Place Your Order
              </button>
              <div className="flex items-center justify-center ">
                <Link href={"/"}>
                  <button className=" text-xs flex items-center gap-1 cursor-pointer font-extrabold">
                    <ArrowLeft className=" text-red-500 w-4" /> BACK TO BUSINESS
                    SERVICES
                  </button>
                </Link>
              </div>
